...
describe('test searchPostAndSitterInfo endpoints', () => {
  xit('gets right response message', (done) => {
    service.connect().then(
      client => client.searchPostAndSitterInfo({pet_type: "cat", hour_rate:15.0, pets_num: 3, avai_start_date: "2018-12-01", avai_end_date:"2019-03-31"}, (err, response) => {
